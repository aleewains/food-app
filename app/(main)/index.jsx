...
import { FoodSlider, RestaurantCard, Header, Search } from "../../components/index"
...
export default function HomeScreen() {
    ...
    const filteredRestaurants = restaurantList.filter(r => {
        const matchCategory = foodCategory === "All" || r.tags.includes(foodCategory);
    ...
    useEffect(() => {
        ...
        const subscription = DeviceEventEmitter.addListener('SCROLL_TO_TOP', (data) => {
            if (data.tab === 'home') {
