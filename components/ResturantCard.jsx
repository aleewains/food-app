    ...
    return (
        ...
        >
            ...
            <View style={{ width: CARD_WIDTH, height: IMAGE_HEIGHT }}>
                ...
                >
                    <Text style={{ fontSize: 15, marginRight: 6, fontFamily: "Adamina-Regular", fontWeight: "400", lineHeight: "100%" }}>
                        {rating}
                    </Text>
            ...
            {/* CONTENT */}
            <View style={{ paddingHorizontal: 20, paddingTop: 5, width: 246.62, height: 67 }}>
                ...
                >
                    {tags.map((tag, i) => (
                        ...
                        >
                            <Text style={{
                                color: "#8A8E9B", fontWeight: "600", fontWeight: "400",
                                fontFamily: "Adamina-Regular", fontSize: 12,
                            }}>
                                {tag}
                            </Text>
                        </View>
